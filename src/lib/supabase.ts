...
const url = process.env.NEXT_PUBLIC_SUPABASE_URL ?? 'https://cwnzezlgtcqkmnyojhbd.supabase.co';
const key = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? 'sb_publishable_bi9fT4Tmp5uApJ36ASeSSA_DHUFBwJQ';
