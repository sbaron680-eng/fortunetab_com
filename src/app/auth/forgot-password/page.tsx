        ...
        <div className="bg-white border border-ft-border rounded-2xl shadow-sm p-8">
          ...
          {sent ? (
            ...
            <div className="text-center space-y-4">
              <div className="w-16 h-16 mx-auto bg-ft-red/10 rounded-full flex items-center justify-center">
                <svg className="w-8 h-8 text-ft-red" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
